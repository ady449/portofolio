...
const About = () => {
	...
	return (
		<div name="about" className="w-full h-screen pt-28 text-gray-300">
			<div className="flex flex-col justify-center items-center w-full h-full">
				<div className="opacity-layer bg-[#0a192f]/75  rounded-xl">
					...
					<div className="tech  xl:justify-center items-center  md:mt-40 flex flex-col  md:flex-row p-10">
						<p className="text-2xl text-center font-light max-md:pb-5 md:border-r-2 md:pr-5 max-md:border-b-2 max-md:w-1/2">
							Tech
						</p>
